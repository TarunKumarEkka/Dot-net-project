    ...
    <asp:MultiView ID="multiViewEmployee" runat="server">
            ...
            <table style="border:1px solid black">
                ...
                <tr>
                    <td colspan="2" style="text-align:right">
                        <asp:Button ID="Button3_Click" runat="server" Text="Step 2 >>" onclick="Button3_Click" Height="26px" />
                    </td>
                </tr>
            </table>
        </asp:View>    
        <asp:View ID="viewContactDetails" runat="server">
            <table style="border:1px solid black">
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button4_Click" runat="server" Text="<< Step 1" 
                            onclick="Button4_Click" />
                    </td>
                    <td style="text-align:right">
                        <asp:Button ID="Button5_Click" runat="server" Text="Step 3 >>" 
